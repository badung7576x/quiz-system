...
class QuestionBankController extends Controller
{
    ...
    {
        $filters = $request->only(['content', 'subject_content_ids', 'question_types', 'from', 'to']);
    ...
    {
        $filters = $request->only(['subject_content_ids', 'question_types', 'from', 'to', 'type', 'ids', 'export_type']);
