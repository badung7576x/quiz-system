  ...
  <div class="content content-boxed">
    <div class="block-rounded block">
      <div class="block-header block-header-default">
        <h3 class="block-title">Thêm môn học mới</h3>
      ...
      <div class="block-content block-content-full">
        <div class="row">
          <div class="col-lg-12 space-y-5">
            ...
            <form id="create_subject" class="" action="{{ route('admin.subject.store') }}" method="POST">
              @csrf
              <div class="row">
                <div class="col-12">
                    <div class="row mb-2">
                  ...
                  <div class="row mb-3">
                    ...
                    <div class="col-12" id="content-area">
                      <div class="row mb-2">
                        ...
                        <div class="col-9">
                          <input type="text" class="form-control @error('subject_contents.0') is-invalid @enderror" name="subject_contents[]" value="{{ old('subject_contents.0', '') }}">
