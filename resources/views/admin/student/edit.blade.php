      ...
      <div class="block-content block-content-full">
        <div class="row">
          <div class="col-lg-12 space-y-5">
            ...
            <form id="update_student" class="space-y-4" action="{{ route('admin.student.update', ['class' => $class->id, 'student' => $student->id]) }}" method="POST">
              @csrf
              @method('PUT')
              <div class="row">
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <input type="text" class="js-flatpickr form-control @error('date_of_birth') is-invalid @enderror" name="date_of_birth"
                    value="{{ old('date_of_birth', $student->date_of_birth) }}" data-date-format="d-m-Y">
                  @error('date_of_birth')
                    <div class="invalid-feedback">{{ $message }}</div>
                  @enderror
                </div>
              ...
              <div class="row">
                ...
                <div class="col-sm-6">
                  <select class="form-select @error('gender') is-invalid @enderror" name="gender">
                      <option value="MALE" @selected(old('gender', $student->gender) == 'MALE')>Nam</option>
